...
type regexpOpsSuite struct {
	suite.Suite
}

func TestRegexpOpsSuite(t *testing.T) {
	suite.Run(t, new(regexpOpsSuite))
}

func (s *regexpOpsSuite) TestIsCDRight() {
	tt := []struct {
		name   string
		b      []byte
		wanted bool
...
func (s *regexpOpsSuite) TestIsCDLeft() {
	tt := []struct {
		name   string
		b      []byte
		wanted bool
...
func (s *regexpOpsSuite) TestIsCTRight() {
	tt := []struct {
		name   string
		b      []byte
		wanted bool
...
func (s *regexpOpsSuite) TestIsCTLeft() {
	tt := []struct {
		name   string
		b      []byte
		wanted bool
...
func (s *regexpOpsSuite) TestIsCTFull() {
	tt := []struct {
		name   string
		b      []byte
		wanted bool
